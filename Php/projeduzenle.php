	...
	<div class="card">
		...
		<div class="card-body">
			<form action="islemler/islem.php" method="POST">
				...
				<div class="form-row mt-2">
					...
					<div class="coll-md-6">
						...
						<select name="proje_durum" class="form-control">
							<option <?php if($projecek['proje_durum'] == "Yeni Başladı"){echo "selected";}?> value="Acil">Yeni Başladı</option>
							<option <?php if($projecek['proje_durum'] == "Devam Ediyor"){echo "selected";}?> value="Acelesi Yok">Devam Ediyor</option>
							<option <?php if($projecek['proje_durum'] == "Bitti"){echo "selected";}?> value="Yeni Başladı">Bitti</option>
						</select>
					</div>
				</div>
				...
				<button name="projeduzenle" type="submit" class="btn btn-primary">Kaydet</button>
			</form>
		</div>
	</div>	
</div>
